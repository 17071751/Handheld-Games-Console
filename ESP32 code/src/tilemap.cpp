...
void TileMapMain::initilise() {
    Serial.printf("Tilemap main initialising at: 0x%08X\n", (uintptr_t)TileMapMain::tileMap);
...
void TileMapUI::initilise() {
    Serial.printf("Tilemap UI initialising at: 0x%08X\n", (uintptr_t)TileMapUI::tileMap);
